...
//			+ "h.ottelcon1 = :ottelcon1, "
			+ "h.otrecibi = :otrecibi, h.cddnisigp = :cddnisigp, h.cdususigp = :cdususigp "
			+ "where h.idHabilitacion = :idHabilitacion")
	int actualizarHabilitacionPersonal(@Param("idHabilitacion") Integer idHabilitacion,
			@Param("cdhabil") String cdhabil, @Param("dsorg") String dsorg, @Param("dsorgext") String dsorgext, @Param("dscentro") String dscentro, 
//			@Param("cddelhac") Integer cddelhac, @Param("cdprov") Integer cdprov, @Param("idsigdom") Integer idsigdom,  @Param("idbanco") Integer idbanco, @Param("idlocalid") Integer idlocalid, @Param("idsucurba") Integer idsucurba,
			...
			@Param("nmaappanx") Integer nmaappanx, @Param("nmmaxanxdes") Integer nmmaxanxdes,
//			@Param("ottelcon1") String ottelcon1,
